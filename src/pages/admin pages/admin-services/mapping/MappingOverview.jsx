...
const MappingOverview = ({ isActive, onClose }) => {
  ...
  } else if (allDayAllNightService && floor === "Second Floor") {
    serviceContent = (
      <div className="card p-4">
        <h3 className="ff-serif">{`${allDayAllNightService.service_name}`}</h3>
  ...
  const secondFloorSeats = allDayAllNightService.seats || []; // Assuming similar structure for second floor

  return (
    <Modal show={isActive} onHide={onClose} size="sm" centered>
                  ...
                  <div className="bottom-area">
                    ...
                    <div>
                      ...
                      <div className="seat-container b-2">
                        <div>
                          {secondFloorSeats.slice(8, 12).map((seat) => (
                            <div
                              className={`seat ${
                                seat.isBooked ? "booked" : "available"
                              }`}
                        ...
                        <div>
                          {secondFloorSeats.slice(12, 16).map((seat) => (
                            <div
                              className={`seat ${
                                seat.isBooked ? "booked" : "available"
                              }`}
